...
@NgModule({
  ...
  declarations: [ IndexComponent, PageCatComponent, AppComponent, ChoixComponent, AjoutAdminComponent, AjoutSuppComponent ],  // Déclaration des "components" de l'application
